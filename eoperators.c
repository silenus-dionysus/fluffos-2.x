...
f_eq()
{
    ...
    case T_OBJECT:
        {
            i = (sp-1)->u.ob == sp->u.ob;
            globalObject.free_object(&(sp--)->u.ob, "f_eq: 1");
            globalObject.free_object(&sp->u.ob, "f_eq: 2");
            break;
        }
...
f_ne()
{
    ...
    case T_OBJECT:
        {
            i = (sp-1)->u.ob != sp->u.ob;
            globalObject.free_object(&(sp--)->u.ob, "f_ne: 1");
            globalObject.free_object(&sp->u.ob, "f_ne: 2");
            break;
        }
