...
{"angle",F_ANGLE,0,0,2,2,TYPE_REAL,T_ARRAY|T_ARRAY,T_ARRAY|T_ARRAY,T_ANY,T_ANY,253,DEFAULT_NONE},
...
{"base_name",F_BASE_NAME,0,0,1,1,TYPE_STRING,T_STRING|T_OBJECT,T_ANY,T_ANY,T_ANY,309,DEFAULT_THIS_OBJECT},
...
{"distance",F_DISTANCE,0,0,2,2,TYPE_REAL,T_ARRAY|T_ARRAY,T_ARRAY|T_ARRAY,T_ANY,T_ANY,253,DEFAULT_NONE},
{"domain_stats",F_DOMAIN_STATS,0,0,0,1,TYPE_MAPPING,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"dotprod",F_DOTPROD,0,0,2,2,TYPE_REAL,T_ARRAY|T_ARRAY,T_ARRAY|T_ARRAY,T_ANY,T_ANY,256,DEFAULT_NONE},
{"dump_file_descriptors",F_DUMP_FILE_DESCRIPTORS,0,0,0,0,TYPE_STRING,T_ANY,T_ANY,T_ANY,T_ANY,0,DEFAULT_NONE},
{"dump_prog",F_DUMP_PROG,0,0,1,-1,TYPE_NOVALUE,T_OBJECT,T_ANY,T_ANY,T_ANY,262,DEFAULT_NONE},
{"dumpallobj",F_DUMPALLOBJ,0,0,0,1,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"ed_cmd",F_ED_CMD,0,0,1,1,TYPE_STRING,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"ed_start",F_ED_START,0,0,0,3,TYPE_STRING,T_STRING,T_NUMBER,T_NUMBER,T_ANY,192,DEFAULT_NONE},
...
{"event",F_EVENT,0,0,2,-1,TYPE_NOVALUE,T_OBJECT|T_ARRAY,T_STRING,T_ANY,T_ANY,303,DEFAULT_NONE},
...
{"filter",F_FILTER,0,0,2,-1,TYPE_ANY,T_STRING|T_ARRAY|T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,226,DEFAULT_NONE},
{"filter_array",F_FILTER | F_ALIAS_FLAG,0,0,2,-1,TYPE_ANY,T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,215,DEFAULT_NONE},
{"filter_mapping",F_FILTER | F_ALIAS_FLAG,0,0,2,-1,TYPE_MAPPING,T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,228,DEFAULT_NONE},
...
{"lookat_rotate",F_LOOKAT_ROTATE,0,0,4,4,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_REAL,T_REAL,265,DEFAULT_NONE},
...
{"map",F_MAP,0,0,2,-1,TYPE_ANY,T_STRING|T_MAPPING|T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,234,DEFAULT_NONE},
...
{"map_mapping",F_MAP | F_ALIAS_FLAG,0,0,2,-1,TYPE_MAPPING,T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,228,DEFAULT_NONE},
...
{"norm",F_NORM,0,0,1,1,TYPE_REAL,T_ARRAY|T_ARRAY,T_ANY,T_ANY,T_ANY,253,DEFAULT_NONE},
...
{"opcprof",F_OPCPROF,0,0,0,1,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
...
{"parse_my_rules",F_PARSE_MY_RULES,0,0,2,3,TYPE_ANY,T_OBJECT,T_STRING,T_NUMBER,T_ANY,281,DEFAULT_NONE},
...
{"parse_sentence",F_PARSE_SENTENCE,0,0,1,4,TYPE_ANY,T_STRING,T_NUMBER,T_ARRAY,T_MAPPING,273,DEFAULT_NONE},
...
{"pow",F_POW,0,0,2,2,TYPE_REAL,T_REAL|T_NUMBER,T_REAL|T_NUMBER,T_ANY,T_ANY,247,DEFAULT_NONE},
...
{"query_ed_mode",F_QUERY_ED_MODE,0,0,0,0,TYPE_NUMBER,T_ANY,T_ANY,T_ANY,T_ANY,0,DEFAULT_NONE},
...
{"replaceable",F_REPLACEABLE,0,0,1,2,TYPE_NUMBER,T_OBJECT,T_ARRAY,T_ANY,T_ANY,295,DEFAULT_NONE},
...
{"resolve",F_RESOLVE,0,0,2,2,TYPE_NUMBER,T_STRING,T_STRING|T_FUNCTION,T_ANY,T_ANY,242,DEFAULT_NONE},
...
{"rotate_x",F_ROTATE_X,0,0,2,2,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_ANY,T_ANY,265,DEFAULT_NONE},
{"rotate_y",F_ROTATE_Y,0,0,2,2,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_ANY,T_ANY,265,DEFAULT_NONE},
{"rotate_z",F_ROTATE_Z,0,0,2,2,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_ANY,T_ANY,265,DEFAULT_NONE},
...
{"scale",F_SCALE,0,0,4,4,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_REAL,T_REAL,265,DEFAULT_NONE},
...
{"set_privs",F_SET_PRIVS,0,0,2,2,TYPE_NOVALUE,T_OBJECT,T_NUMBER|T_STRING,T_ANY,T_ANY,221,DEFAULT_NONE},
...
{"socket_accept",F_SOCKET_ACCEPT,0,0,3,3,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_ANY,312,DEFAULT_NONE},
{"socket_acquire",F_SOCKET_ACQUIRE,0,0,4,4,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,343,DEFAULT_NONE},
{"socket_address",F_SOCKET_ADDRESS,0,0,2,2,TYPE_STRING,T_NUMBER|T_OBJECT,T_NUMBER,T_ANY,T_ANY,354,0},
...
{"socket_connect",F_SOCKET_CONNECT,0,0,4,4,TYPE_NUMBER,T_NUMBER,T_STRING,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,320,DEFAULT_NONE},
{"socket_create",F_SOCKET_CREATE,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_ANY,312,DEFAULT_NONE},
...
{"socket_release",F_SOCKET_RELEASE,0,0,3,3,TYPE_NUMBER,T_NUMBER,T_OBJECT,T_STRING|T_FUNCTION,T_ANY,336,DEFAULT_NONE},
{"socket_status",F_SOCKET_STATUS,0,0,0,1,TYPE_MOD_ARRAY|TYPE_ANY,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"socket_write",F_SOCKET_WRITE,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_ANY,T_STRING,T_ANY,330,DEFAULT_NONE},
...
{"store_variable",F_STORE_VARIABLE,0,0,2,2,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,299,DEFAULT_NONE},
...
{"terminal_colour",F_TERMINAL_COLOUR,0,0,2,4,TYPE_STRING,T_STRING,T_MAPPING,T_NUMBER,T_NUMBER,287,DEFAULT_NONE},
...
{"translate",F_TRANSLATE,0,0,4,4,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_REAL,T_REAL,265,DEFAULT_NONE},
