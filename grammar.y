...
#line 400 "grammar.y.pre"
		$$ = globalScratchP.scratch_copy($1->name);
	    }
     |  L_IDENTIFIER
     ;
...
#line 3312 "grammar.y.pre"
		$$ = globalScratchP.scratch_join($1, $3);
	    }
    ;
...
#line 3320 "grammar.y.pre"
		$$ = globalScratchP.scratch_join($1, $2);
	    }
    ;
...
#line 3706 "grammar.y.pre"
		 ...
		 * "name" -> ":::name"
		 */
		$$ = globalScratchP.scratch_realloc($2, l + 3);
		p = $$ + l;
		while (p--,l--)
		    *(p+3) = *p;
		strncpy($$, ":::", 3);
...
#line 3720 "grammar.y.pre"
		...
		$$ = globalScratchP.scratch_realloc($3, l + z);
		p = $$ + l;
		while (p--,l--)
		    *(p+z) = *p;
		$$[0] = ':';
...
#line 3735 "grammar.y.pre"
		int l = strlen($1);
		/* "ob" and "name" -> ":ob::name" */
		$$ = globalScratchP.scratch_alloc(l + strlen($3) + 4);
		*($$) = ':';
		strcpy($$ + 1, $1);
		strcpy($$ + l + 1, "::");
		strcpy($$ + l + 3, $3);
